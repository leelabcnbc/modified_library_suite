function converter_test( rootDir )
...
f = fopen(fullfile(rootDir,'t10k-images-idx3-ubyte'),'r');
[a,count] = fread(f,4,'int32');
  
g = fopen(fullfile(rootDir,'t10k-labels-idx1-ubyte'),'r');
...
f = fopen(fullfile(rootDir,'train-images-idx3-ubyte'),'r');
[a,count] = fread(f,4,'int32');

g = fopen(fullfile(rootDir,'train-labels-idx1-ubyte'),'r');
[l,count] = fread(g,2,'int32');
